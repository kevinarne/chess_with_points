...
- Under Components, select Custom Deck, place the deck on the table, then hit escape to get the import dialog box to pop up.
- Find cards.png on your computer and upload it as both the fronts and backs of the cards.
- Set width to 10, height to 6, and number of cards to 54


# Roadmap
- Add images to importing workflow
- Create unique icons for each piece
